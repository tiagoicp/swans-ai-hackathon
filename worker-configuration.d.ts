/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 011d52923951cca82c1bb6b32a077a47)
// Runtime types generated with workerd@1.20260722.1 2026-03-24 nodejs_compat
interface __BaseEnv_Env {
	BROWSER: BrowserRun;
	AI: Ai;
	ChatAgent: DurableObjectNamespace<import("./src/server/index").ChatAgent>;
	RunProgress: DurableObjectNamespace<import("./src/server/index").RunProgress>;
	JOKE_WORKFLOW: Workflow<Parameters<import("./src/server/index").JokeWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "ChatAgent" | "RunProgress";
	}
